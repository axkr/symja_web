...
public class EvaluateServlet extends HttpServlet {
  ...
  public static String evaluate(HttpServletRequest request, String expression, String numericMode,
  ...
  public static String[] evaluateString(HttpServletRequest request, EvalEngine engine,
      final String inputString, final String numericMode, final String function) {
   ...
   */
  // private boolean putToMemcache(IExpr lhsExpr, IExpr rhsExpr) {
  // try {
  // ArrayList<IExpr> list = new ArrayList<IExpr>();
  // Map<IExpr, IExpr> map = new HashMap<IExpr, IExpr>();
  // lhsExpr = lhsExpr.variables2Slots(map, list);
  ...
  // }
  // } catch (Exception ex) {
  // LOGGER.error("{}.evaluateString() failed", getClass().getSimpleName(), ex);
  // }
  // return false;
  // }
