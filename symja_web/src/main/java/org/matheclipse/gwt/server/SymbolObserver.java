...
public class SymbolObserver implements ISymbolObserver {
	...
	/**
	 * Load an associated package from the Appengines datastore, if a new &quot;symbol starting with an uppercase
	 * character&quot; is defined. Doesn't load a package multiple times, if it's already loaded.
	 * 
